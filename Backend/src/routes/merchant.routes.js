...
import {getOrdersForMerchant,orderPacked} from '../controllers/userControllers/order.controllers.js';
...
router.get('/getOrders',authMiddlewareMerchant,getOrdersForMerchant);
